...
```
*(Giải thích: User 2 có tổng cộng 2 đơn 'paid', nhưng do limit=1 nên data chỉ trả về 1 bản ghi).*
...
```
*(Giải thích: Lấy tất cả trạng thái, mặc định trả về tối đa 5 đơn. User 1 có 3 đơn nên trả về cả 3).*
